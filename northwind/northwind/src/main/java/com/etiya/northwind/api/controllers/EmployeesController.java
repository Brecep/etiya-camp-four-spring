...
private EmployeeService employeeService;
	...
	@PostMapping("/add")
	public Result add(@RequestBody CreateRequestEmployee createRequestEmployee) {
		return this.employeeService.add(createRequestEmployee);
	}
	...
	@PostMapping("/update")
	public Result update(@RequestBody UpdateRequestEmployee updateRequestEmployee) {
		return this.employeeService.update(updateRequestEmployee);
	}
	
	@PostMapping("/delete")
	public Result delete(@RequestBody DeleteRequestEmployee deleteRequestEmployee) {
		return this.employeeService.delete(deleteRequestEmployee);
	}
