...
private OrderDetailService orderDetailService;
	...
	@PostMapping("/add")
	public Result add(@RequestBody CreateRequestOrderDetail createRequestOrderDetail) {
		return this.orderDetailService.add(createRequestOrderDetail);
	}
	
	@GetMapping("/getById")
	public DataResult<GetOrderDetailResponse> getById(@RequestParam int orderId,@RequestParam int productId){
	...
	@PostMapping("/update")
	public Result update(@RequestBody UpdateRequestOrderDetail updateRequestOrderDetail) {
		return this.orderDetailService.update(updateRequestOrderDetail);
	}
	
	@PostMapping("/delete")
	public Result delete(@RequestBody DeleteRequestOrderDetail deleteRequestOrderDetail) {
		return this.orderDetailService.delete(deleteRequestOrderDetail);
	}
...
//	    }
	...
	public DataResult<List<OrderDetailListResponse>> getAllPages(int pageNo, int pageSize){
