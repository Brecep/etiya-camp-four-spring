...
public class OrderDetailManager implements OrderDetailService {
	...
	@Override
	public Result add(CreateRequestOrderDetail createRequestOrderDetail) {
	...
	@Override
	public Result update(UpdateRequestOrderDetail updateRequestOrderDetail) {
	...
	@Override
	public Result delete(DeleteRequestOrderDetail deleteRequestOrderDetail) {
	...
	public DataResult<GetOrderDetailResponse> getById(int orderId, int productId) {
		...
		return new SuccessDataResult<GetOrderDetailResponse>(response);
	}
